<?php 
   ...
   $w_id = $_GET['wuid'];
    ...
    $sql = "SELECT * FROM `w_bill` WHERE w_id='$w_id'";
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = "UPDATE `w_bill` SET w_id='$w_id', bill_no='$bill_no',bill_date='$bill_date',cp_no='$cp_no',house_type='$house_type',u_id='$u_id',amount ='$amount',pay_info='$pay_info' WHERE w_id='$w_id'";
        ...
        <div class="container">
          ...
          <form action="" method="POST">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control"  placeholder="Enter House_Type" name="house_type" value=<?php echo $house_type; ?>>
            </div>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control"  placeholder="Enter Pay Info" name="pay_info" value=<?php echo $pay_info; ?>>
            </div>
